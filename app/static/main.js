...
var myModalEl = document.getElementById('delete-film-modal');
myModalEl.addEventListener('show.bs.modal', function (event) {
  let form = this.querySelector('form');
  form.action = event.relatedTarget.dataset.url;
  let filmNameEl = document.getElementById('film-name-id');
  filmNameEl.innerHTML = document.querySelector('.film-name').textContent;
})
...
window.onload = function() {
    ...
    for (let course_elm of document.querySelectorAll('.films-list .row')) {
